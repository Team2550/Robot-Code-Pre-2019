...
void GripPipeline::process(cv::Mat source0){
	...
	double hsvThresholdHue[] = {59.89208633093526, 102.72727272727273};
	double hsvThresholdSaturation[] = {121.48331037672557, 238.36062670548077};
	...
	double blurRadius = 9.009009009009006;  // default Double
